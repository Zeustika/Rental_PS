 ...
 */
    ...
    if($_GET['cari'])
    {
        ...
        $query =  $koneksi -> query('SELECT * FROM playstation WHERE jenis_ps LIKE "%'.$cari.'%" ORDER BY id_ps DESC')->fetchAll();
    }else{
            ...
            <div class="col-sm-4">
                ...
                <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;object-fit:cover;">
                    <div class="card-body" style="background:#ddd">
                        <h5 class="card-title"><?php echo $isi['jenis_ps'];?></h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        ...
                        <?php }?>
                        <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Free 2 Stick Ps</li>

                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Type penyewaan</label>
                                <input type="text" class="form-control col-sm-9" name="type_sewa" placeholder="Isi Type penyewaan">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">jenis_ps playstation</label>
                                <input type="text" class="form-control col-sm-9" name="jenis_ps" placeholder="Isi jenis_ps">
                            </div>

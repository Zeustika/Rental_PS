...
<div class="container">
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                Edit playstation - <?= $hasil['jenis_ps'];?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['type_sewa'];?>" name="type_sewa" placeholder="Isi No Plat">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">jenis_ps playstation</label>
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['jenis_ps'];?>" name="jenis_ps" placeholder="Isi jenis_ps">
                            </div>
